...
export default function Punch({ user, employeeId, employeeLocation }) {
  ...
  const handlePunch = (type) => {
    ...
    fetch(
      "https://script.google.com/macros/s/AKfycbxrHkM0tFFFpE5zyZGF45hKVh6TCd-q05bC-4HsSiMuXGoy0PVirQXS1vLxyMXnhg06/exec",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/x-www-form-urlencoded",
  ...
  const fetchAttendance = async () => {
    try {
      const res = await fetch(
        `https://script.google.com/macros/s/AKfycbxrHkM0tFFFpE5zyZGF45hKVh6TCd-q05bC-4HsSiMuXGoy0PVirQXS1vLxyMXnhg06/exec?employeeId=${employeeId}&action=attendance`
      );
